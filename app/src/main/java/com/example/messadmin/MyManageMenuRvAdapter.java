...
public class MyManageMenuRvAdapter extends RecyclerView.Adapter<MyManageMenuRvAdapter.ViewHolder> {
    ...
    public MyManageMenuRvAdapter(List<MenuItem> menuItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        viewHolder.Price.setText(rest.getPrice().toString());
